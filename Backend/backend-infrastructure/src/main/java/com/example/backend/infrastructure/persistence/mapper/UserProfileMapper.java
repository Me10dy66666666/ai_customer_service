...
import com.example.backend.infrastructure.persistence.entity.UserProfile;
...
public interface UserProfileMapper {
    ...
    List<UserProfile> listByConditions(@Param("userType") String userType,
                                       ...
                                       @Param("allUserType") String allUserType,
                                       @Param("memberType") String memberType,
                                       @Param("registeredType") String registeredType);
}
